...
public enum HTTPStatusCode: Int, Sendable {
    ...
    // - invalidStatus: This is not a valid HTTP status code, but can be used as an initializer.
    ...
    /// - webServerUnknownError: Web server is returning an unknown error
    case webServerUnknownError = 520

    /// - invalidSSLCertificate: When ther actual certificate is not valid for SSL conection
